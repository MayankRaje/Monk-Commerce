...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({InvalidCouponException.class, CouponNotApplicableException.class})
    public ResponseEntity<ErrorResponse> handleInvalidCouponException(RuntimeException ex, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse(
                LocalDateTime.now(),
